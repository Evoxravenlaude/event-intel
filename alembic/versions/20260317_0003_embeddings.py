...
def upgrade() -> None:
    if _is_postgres():
        # pgvector stores embeddings natively — far more efficient than JSON text.
        # The HNSW index supports fast approximate nearest-neighbour search.
        ...
        # HNSW index for cosine distance — used when doing nearest-neighbour lookups
        op.execute(
        ...
        # SQLite: store embeddings as JSON text. Python cosine is used for comparison.
